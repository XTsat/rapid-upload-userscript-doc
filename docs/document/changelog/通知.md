...
- 2022.5.20:
  - 原依赖cdn jsdelivr加载失败会导致脚本延迟运行或无法安装, 故放弃多cdn方案, 2.2.4版本已将cdn全部更换为unpkg

- 2022.1.26:
  - ~~最近反馈外部资源加载失败的问题有点严重, 故2.1.2版本添加了备用cdn, 即使jsdelivr寄掉也能保证脚本正常运行了~~
...
- 2021.7.10:
  - (<span style="color: red;"> 重要 </span>) 从7.9开始, 新上传网盘的文件<span style="color: red;"> 很可能 </span>出现 "秒传未生效", "md5获取失败"的问题, 疑似百度服务器异常, 正在尝试修复 [错误代码](/document/常见问题/错误代码.md) 内提供了临时的解决方法
